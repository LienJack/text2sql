...
- Text2SQL v2 active runtime seam 固定为 `Text2SQLWorkflowRunner -> RunV2LangGraphStage -> Text2SqlV2LangGraphRunnerService`，并落位于 `conversation/application/workflow` 与 `conversation/runtime/text2sql-v2/**` 分层目录；`RunV2StateMachineStage` 仅保留兼容壳角色。
